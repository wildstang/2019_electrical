...
//QTRSensorsRC lightSensors((unsigned char[]) {23, 25, 27, 29, 31, 33, 35, 37, 39, 41, 43, 47, 49, 51}, 14); // 14 sensor array 
...
void setup() {
    ...
    for(int i = 0; i < 16; i++) {
      Serial.print(i);
      Serial.print(": ");
      Serial.println(qtrrc.calibratedMinimumOn[i] - qtrrc.calibratedMaximumOn[i]);
    }
